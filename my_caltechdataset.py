...
from /usr/local/lib/python3.6/dist-packages/torchvision/datasets/vision import VisionDataset
from ./usr/local/lib/python3.6/dist-packages/torchvision/datasets/tils import download_url, makedir_exist_ok
